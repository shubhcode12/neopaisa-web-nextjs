  ...
  return (
    <main className="relative bg-[#0c0c10] my-16 flex justify-center items-center flex-col overflow-hidden mx-auto sm:px-10">
      ...
      <div className="p-4 md:p-8 text-white-900">
        ...
        <p>
          This privacy policy applies to the NeoPaisa app (hereby referred to as
          &quot;Application&quot;) for mobile devices that was created by
          Giantwheel Technology (hereby referred to as &quot;Service
        ...
        <p className="mt-4">
          ...
          identifiable information, including but not limited to Phone Number,
          PAN, Name on PAN, Aadhar Number, Father&apos;s Name, Marital Status,
          Address Line, Landmark, Zip Code, City, State, Type of Residence,
          Purpose, Company Name, Monthly Income, Designation, Total Work
          Experience, Office Address. The information that the Service Provider
        ...
        <p>
          ...
          <a href="mailto:neopaisa.com@gmail.com" className="text-blue-500">
            neopaisa.com@gmail.com
          </a>{" "}
